...
namespace App\Services\Formazione\DesignPatterns;

//Real World Example
//In this example, the Factory Method pattern provides an interface for creating social network connectors,
// which can be used to log in to the network, create posts and potentially perform other activities—and
// all of this without coupling the client code to specific classes of the particular social network.
