...
function clientCode()
{
    ...
    $draft = clone $page;
    $author->changeName("Billie Holiday");

    if ($page->getAuthorName() !== $draft->getAuthorName()) {
        echo printf("Author name is changed from %s to %s", $page->getAuthorName(), $draft->getAuthorName());
    }
